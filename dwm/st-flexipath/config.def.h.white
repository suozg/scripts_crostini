...
static const char *colorname[] = {
    ...
    [5] = "#7A4F7A", /* magenta */
    [6] = "#2F7F7A", /* cyan */
    [7] = "#444444", /* white -> змінено на ТЕМНО-СІРИЙ, щоб було видно на світлому */
    ...
    [13] = "#7A4F7A",
    [14] = "#2F7F7A",
    [15] = "#1A1A1A", /* bright white -> змінено на МАЙЖЕ ЧОРНИЙ */

    [255] = 0,

    /* default fg / bg */
    [256] = "#2A2E2A", /* основний текст */
    [257] = "#E3E2CF", /* фон паперу */
    [258] = "#2F7F7A", /* курсор */
};

/* Default colors */
unsigned int defaultfg = 256; /* Тепер посилається на #2A2E2A */
